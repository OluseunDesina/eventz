...
namespace web_api_eventz.Controllers
{
    ...
    public class EventContoller: ControllerBase
    {
        ...
        public async Task<IActionResult> DuplicateEvent([FromRoute] int eventId) {
            ...
            return CreatedAtAction(nameof(GetEventById), new { EventId = eventToDuplicate.Id }, eventToDuplicate.ToEventDto());
        }
        ...
        public async Task<IActionResult> CreateEvent([FromBody] CreateEventDto eventDto) {
            ...
            return CreatedAtAction(nameof(GetEventById), new { EventId = createdEvent.Id }, createdEvent.ToEventDto());
        }
