        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SalesStartDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                    SalesEndDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TicketHistorys_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TicketHistorys_Events_EventId",
                        column: x => x.EventId,
                        principalTable: "Events",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "686a44c9-b7b4-4233-a9d6-472fc30481f9", null, "Admin", "ADMIN" },
                    { "6aa43c17-f709-4406-9bb5-6a564a87ab8b", null, "Organizer", "ORGANIZER" },
                    { "cbd7b5ef-0695-4ff3-9e6f-8b0a2daeba1c", null, "User", "USER" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TicketHistorys_AppUserId",
                table: "TicketHistorys",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_TicketHistorys_EventId",
                table: "TicketHistorys",
                column: "EventId");
